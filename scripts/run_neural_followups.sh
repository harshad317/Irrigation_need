...
while pgrep -f 'scripts/solution.py --run-name stress_signals_(ft_stack_v1|ann_stack_scaled_v1)' >/dev/null; do
  sleep 60
done

run_experiment stress_signals_cnn_stack.log \
...
run_experiment stress_signals_rnn_stack.log \
